...
namespace client.CoppeliaSim
{
    ...
    /// <summary>
    /// Enum for scene port numbers
    /// </summary>
    public enum ScenePortNumbers
    {
        idle_scene_port = 19999,
        circulation_scene_port = 19998,
        sensortest_scene_port = 19996,
    }
    /// <summary>
    ...
    {
        idle_scene_name,
        circulation_scene_name,
        sensortest_scene_name,
    }
